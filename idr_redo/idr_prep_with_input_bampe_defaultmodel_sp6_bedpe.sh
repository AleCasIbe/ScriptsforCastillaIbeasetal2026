...
folder=$1
name_folder=${folder##*/}
file1=$folder/chipd_sp6_rep1_sorted_filt_chr.bedpe
file2=$folder/chipd_sp6_rep2_sorted_filt_chr.bedpe
input1=$folder/input_sp6_rep1_sorted_filt_chr.bedpe
input2=$folder/input_sp6_rep2_sorted_filt_chr.bedpe

### Cuando se llama al programa se le da el tamanio del genoma como argumento. 
### gsize mm10 = 2730871774

###gsize=$2

### Se copian los datos requeridos en el archivo temporal SCRATCH

cp $file1 $SCRATCH/1.bedpe
cp $file2 $SCRATCH/2.bedpe
cp $input1 $SCRATCH/i1.bedpe
cp $input2 $SCRATCH/i2.bedpe

### Se crea la carpeta results en SCRATCH. 

cd $SCRATCH
cat i1.bedpe i2.bedpe > input.bedpe
...
### had some macs2 compatibility issues with python, right now is:
### micromamba activate macs2_python_37


echo 'Starting proper replicate peak calling'
mkdir CONS_PEAKS
macs2 callpeak -f BEDPE -t ../1.bedpe -c ../i1.bedpe -p 0.02 --keep-dup auto -g mm -n ${name_folder}_rep1 --outdir ./CONS_PEAKS &
macs2 callpeak -f BEDPE -t ../2.bedpe -c ../i2.bedpe -p 0.02 --keep-dup auto -g mm -n ${name_folder}_rep2 --outdir ./CONS_PEAKS &
macs2 callpeak -f BEDPE -t ../1.bedpe ../2.bedpe -c ../input.bedpe -p 0.02 --keep-dup auto -g mm -n ${name_folder}_pooled_rep --outdir ./CONS_PEAKS &
wait %1 %2 %3
...
nlines1=$( cat ../1.bedpe | wc -l ) 
halfnlines1=$(( (nlines1 + 1) / 2 )) 
cat ../1.bedpe | shuf | split -d -l ${halfnlines1} - ./OPT_PEAKS/${name_folder}_rep1_ps  ## -d indica que se pondran sufijos numericos

nlines2=$( cat ../2.bedpe | wc -l ) 
halfnlines2=$(( (nlines2 + 1) / 2 )) 
cat ../2.bedpe | shuf | split -d -l ${halfnlines2} - ./OPT_PEAKS/${name_folder}_rep2_ps

cat ../1.bedpe ../2.bedpe | shuf > ./pooled.bedpe
nlinesp=$( cat ./pooled.bedpe | wc -l ) 
halfnlinesp=$(( (nlinesp + 1) / 2 )) 
cat ./pooled.bedpe | shuf | split -d -l ${halfnlinesp} - ./OPT_PEAKS/${name_folder}_pool_ps 
...
macs2 callpeak -f BEDPE -t ./OPT_PEAKS/${name_folder}_rep1_ps00 -c ../i1.bedpe --keep-dup auto -p 0.02 -g mm -n ${name_folder}_rep1_ps00 --outdir ./OPT_PEAKS &
macs2 callpeak -f BEDPE -t ./OPT_PEAKS/${name_folder}_rep1_ps01 -c ../i1.bedpe --keep-dup auto -p 0.02 -g mm -n ${name_folder}_rep1_ps01 --outdir ./OPT_PEAKS &

macs2 callpeak -f BEDPE -t ./OPT_PEAKS/${name_folder}_rep2_ps00 -c ../i2.bedpe --keep-dup auto -p 0.02 -g mm -n ${name_folder}_rep2_ps00 --outdir ./OPT_PEAKS &
macs2 callpeak -f BEDPE -t ./OPT_PEAKS/${name_folder}_rep2_ps01 -c ../i2.bedpe --keep-dup auto -p 0.02 -g mm -n ${name_folder}_rep2_ps01 --outdir ./OPT_PEAKS &

macs2 callpeak -f BEDPE -t ./OPT_PEAKS/${name_folder}_pool_ps00 -c ../input.bedpe --keep-dup auto -p 0.02 -g mm -n ${name_folder}_pool_ps00 --outdir ./OPT_PEAKS &
macs2 callpeak -f BEDPE -t ./OPT_PEAKS/${name_folder}_pool_ps01 -c ../input.bedpe --keep-dup auto -p 0.02 -g mm -n ${name_folder}_pool_ps01 --outdir ./OPT_PEAKS &
